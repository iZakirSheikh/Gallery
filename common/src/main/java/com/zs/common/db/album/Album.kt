 ...
 * @property poster - Represents the poster image of this [Album]
...
class Album internal constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this@Album.poster != other.poster) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + (this@Album.poster?.hashCode() ?: 0)
        return result
    }

    override fun toString(): String {
        return "Album(id=$id, name='$name', description=$description, dateAdded=$dateAdded, dateModified=$dateModified, count=$count, poster=${this@Album.poster})"
    }
