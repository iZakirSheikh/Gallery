...
@Composable
private inline fun ActionIconButton(
    action: action,
...
fun OverflowMenu(
    ...
    repeat(minOf(size, collapsed)) { index ->
        ...
        ActionIconButton(action, onClick = { onMenuAction(action) })
    }
    ...
    AnimatedVisibility(
        ...
        content = {
            Surface(
                ...
                content = {
                    Row(
                        horizontalArrangement = Arrangement.spacedBy(Res.dimen.x_small),
