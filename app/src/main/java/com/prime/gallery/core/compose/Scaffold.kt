...
import com.prime.gallery.core.compose.snackbar.SnackbarHost2
...
fun Scaffold2(
    ...
    channel: SnackbarHostState2 = remember(::SnackbarHostState2),
...
private inline fun Vertical(
    ...
    Layout(
        ...
        var h = height - (orgNavBarHeightPx - navBarHeight).coerceAtLeast(0f).toInt()
